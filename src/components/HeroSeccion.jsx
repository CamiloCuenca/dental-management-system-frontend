...
const HeroSeccion = () => {
    return (
        <div className="bg-gradient-to-r from-[var(--color-primary)] via-[var(--color-secondary)] to-[var(--color-accent)] 
            ...
            <div className="w-full md:w-[50%] lg:w-[65%] text-left text-white px-6 md:px-12">
                ...
                <div className="mt-5 flex flex-col md:flex-row md:space-x-4 space-y-3 md:space-y-0">
                    <a 
                        href="/citas"
